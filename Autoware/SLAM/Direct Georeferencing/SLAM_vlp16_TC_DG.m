...
%[FileName_pcap, PathName_pcap, ~] = uigetfile('*.pcap', 'Please Select .pcap File.');
...
%[FileName_IE, PathName_IE, ~] = uigetfile('*.txt', 'Please Select .txt File.');
...
PathName_output = 'C:\Users\user\Documents\code_git\Autoware\SLAM\Direct Georeferencing\output-pcd';
...
FileName_output = sprintf('vlp16_DG_%05d_%05d.pcd', stratFrame, endFrame);
