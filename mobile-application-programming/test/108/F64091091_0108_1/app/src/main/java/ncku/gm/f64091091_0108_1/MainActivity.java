...
public class MainActivity extends AppCompatActivity
    ...
    public void data_set(){
        ...
        RadioButton rbtn_a = findViewById(R.id.rbtn_a);
        RadioButton rbtn_b = findViewById(R.id.rbtn_b);
        RadioButton rbtn_o = findViewById(R.id.rbtn_o);
        RadioButton rbtn_ab = findViewById(R.id.rbtn_ab);
        ...
        CheckBox cb1= findViewById(R.id.cb_basketball);
        CheckBox cb2= findViewById(R.id.cb_baseball);
        CheckBox cb3= findViewById(R.id.cb_badminton);
        ...
        str_show = "履歷 : 我姓" + str_first_name + "名" + str_last_name_1 + str_last_name_2 + ",今年" + old + "歲"
